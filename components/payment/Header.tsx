  ...
  return (
    ...
    >
      <div className="relative w-full px-5 py-2 h-[45px] items-center justify-between bg-black shadow-sm mb-10 whitespace-nowrap">
        <div className="absolute sm:text-sm lg:text-lg top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] text-[17px] text-white font-bold uppercase tracking-wider scale-x-90">
