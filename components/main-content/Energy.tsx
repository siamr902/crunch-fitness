...
const Energy = () => {
  return (
    <div className="flex justify-center flex-col items-center space-y-4 mt-5 p-5">
      ...
      <div className="uppercase tracking-[3px] text-center text-red-700 pt-3 font-bold text-xs cursor-pointer hover:text-black transition ease-in-out duration-300">
